...
#ifdef gSPIInterface_d
  #include "SPI_Interface.h"
#endif

#ifdef gI2CInterface_d
...
#if ((defined(gSPIInterface_d) && defined(gI2CInterface_d)) || \
     (defined(gSCIInterface_d) && defined(gSPIInterface_d)) || \
     (defined(gSCIInterface_d) && defined(gI2CInterface_d)) || \
     (defined(gCDCInterface_d) && defined(gSPIInterface_d)) || \
     (defined(gCDCInterface_d) && defined(gI2CInterface_d)) || \
     (defined(gCDCInterface_d) && defined(gSCIInterface_d)))
 #error "Error: Configuration not supported. Multiple communication interfaces defined"
#endif
  ...
  #define ZtcComm_GetByteFromRxBuffer   CDC_GetByteFromRxBuffer
  #define ZtcComm_Transmit              CDC_Transmit
  #define ZtcComm_IsTxActive            CDC_IsTxActive  
  
#else
  #error "A serial communication interface must be enabled to use ZTC."  
#endif
