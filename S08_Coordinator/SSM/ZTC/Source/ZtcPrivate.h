...
#endif
  mZtcMsgGetLastReceivedPacketLqiValue_c = 0x2D, /* ZTC-GetLastReceivedPacketLqiValue.Request       */
  mZtcMsgGetMaxProgramStackUsage_c  = 0x2E,
#ifdef gZtcOtapSupport_d  
  mZtcOtapSupportImageChunkReq_c    = 0x2F,
#endif
#if gUseHwValidation_c
  mZtcLowLevelMemoryWriteBlock_c    = 0x30, /* ZTC-WriteRAMMemoryBlock.Request      */
  mZtcLowLevelMemoryReadBlock_c     = 0x31, /* ZTC-ReadMemoryBlock.Request          */  
  mZtcLowLevelPing_c                = 0x38, /* ZTC-Ping.Request                     */ 
  mZtcLowLevelAbelWrite_c           = 0x39, /* ZTC-AbelWrite.Request                */ 
  mZtcLowLevelAbelRead_c            = 0x3A, /* ZTC-AbelRead.Request                 */
  mZtcLowLevelMC1323xWriteTrimValue_c = 0x49, /* ZTC-MC1323xWriteTrimValue */
  mZtcLowLevelMC1323xReadTrimValue_c  = 0x4A, /* ZTC-MC1323xReadTrimValue */
#endif /* gUseHwValidation_c */ 
  mZtcMsgSelectWakeUpPINReq_c       = 0x4B, /* ZTC-SelectWakeUpPIN.Request          */
  mZtcMsgWakeUpIndication_c         = 0x4C, /* ZTC-WakeUp.Indication                */
#ifdef gZtcOtapSupport_d  
