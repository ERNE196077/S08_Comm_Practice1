...
enum {  
  gSecSuiteNoSecurity_c   = 0x00,
  gSecSuiteAesCbcMac32_c  = 0x01,  
  gSecSuiteAesCbcMac64_c  = 0x02,
  gSecSuiteAesCbcMac128_c = 0x03,
  gSecSuiteAesCtr_c       = 0x04,
  gSecSuiteAesCcm32_c     = 0x05,
  gSecSuiteAesCcm64_c     = 0x06,      
  gSecSuiteAesCcm128_c    = 0x07,      
  // The value 0x08 signifies that no security suite is used
  gSecSuiteNone_c         = 0x08
};
...
enum {
  ...
  gMPibBeaconEDCfpStartTrimVaue_c       = 0x28,
...
typedef struct mcpsPromInd_tag {
  uint8_t  mpduLinkQuality;
  uint32_t timeStamp;     // Converted to Little Endian
