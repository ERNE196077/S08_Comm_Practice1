 ...
 */
 ...
 #if (defined (PROCESSOR_MC13238C) && (gMC1323xKBI2Enable_d == TRUE))
  #error "KBI Configuration not supported on MC13238C"
 #endif /* (defined (PROCESSOR_MC13238C) && (gMC1323xKBI2Enable_d == TRUE)) */ 
