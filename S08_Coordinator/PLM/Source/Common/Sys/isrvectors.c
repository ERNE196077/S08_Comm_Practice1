...
#if defined(PROCESSOR_MC13238C)        
  #if (gUsbIncluded_d == 1)
        USB_ISR,                 // vector 26   - USB interrupt
  #else
        Default_Dummy_ISR,       // vector 26   - NOT A REAL VECTOR
  #endif
#elif defined(PROCESSOR_MC13237C)  
  #if (gADC_Enabled_d == 1)
        ADC_ISR,                 // vector 26   - ADC interrupt
  #else
        Default_Dummy_ISR,       // vector 26   - NOT A REAL VECTOR
  #endif
#else
        Default_Dummy_ISR,       // vector 26   - NOT A REAL VECTOR
#endif //defined(PROCESSOR_MC13238C)
#if (gLpmIncluded_d == 1)
...
******************************************************************************/
  ...
  from software */  
    ...
    #pragma CODE_SEG IRQ_VECTOR_SECTION_DEFAULT
      ...
      #if (gADC_Enabled_d == 1)
        void __interrupt near JumpFunctionISR19(void){ADC_ISR();};
      #else
    ...
    #if defined(PROCESSOR_MC13238C)        
      #if (gUsbIncluded_d == 1)
        void __interrupt near JumpFunctionISR26(void){USB_ISR();};
      #else
        void __interrupt near JumpFunctionISR26(void){Default_Dummy_ISR();};
      #endif
    #elif defined(PROCESSOR_MC13237C)  
      #if (gADC_Enabled_d == 1)
        void __interrupt near JumpFunctionISR26(void){ADC_ISR();};
      #else
        void __interrupt near JumpFunctionISR26(void){Default_Dummy_ISR();};
      #endif
    #else
