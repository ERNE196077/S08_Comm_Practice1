...
/*    uint16_t i = 1550; */
    ...
    if ( ClkMode == Normal_16MHz) {
      ...
      }while(reg != ((gHardwareParameters.Abel_Clock_Out_Setting & 0xfff8) | RADIO_CLKO_62_50KHZ));    	
    ...
    /* PROCESSOR is QE128 (PROCESSOR_QE128) */
    {
      ...
      /*       BDIV1   BDIV0    RANGE     HGO       LP     EREFS   ERCLKEN  EREFSTEN */
      ICSC2 = (0<<7) | (0<<6) | (0<<5) | (0<<4) | (0<<3) | (0<<2) | (0<<1) | (0<<0);
      /*       CLKS1   CLKS0    RDIV2    RDIV1    RDIV0    IREFS   IRCLKEN  IREFSTEN */
      ICSC1 = (0<<7) | (0<<6) | (0<<5) | (0<<4) | (0<<3) | (1<<2) | (0<<1) | (0<<0);
      /*            DRS1     DRS0    DMX32    IREFST   CLKST1   CLKST0   OSCINIT  FTRIM */
      icssc_temp = (0<<7) | (1<<6) | (0<<5) | (1<<4) | (0<<3) | (0<<2) | (0<<1) | (0<<0);  
      ICSSC = icssc_temp;
      while(!(ICSSC == icssc_temp));   /* Wait for the FLL to lock on the internal clock source */       
