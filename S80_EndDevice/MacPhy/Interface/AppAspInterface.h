...
************************************************************************************/
 ...
 // Valid values for Asp_SetPowerLevel() for MC1323x.
 // For this platform, only 15 power levels (0-14) are supported.
enum {
  gAspPowerLevel_m30dBm,    /* -30  dBm (hex: 0x00) */
  gAspPowerLevel_m29dBm,    /* -29  dBm (hex: 0x01) */
  gAspPowerLevel_m25dBm,    /* -25  dBm (hex: 0x02) */
  gAspPowerLevel_m23dBm,    /* -23  dBm (hex: 0x03) */
  gAspPowerLevel_m21dBm,    /* -21  dBm (hex: 0x04) */
  gAspPowerLevel_m19dBm,    /* -19  dBm (hex: 0x05) */
  gAspPowerLevel_m16dBm,    /* -16  dBm (hex: 0x06) */
  gAspPowerLevel_m14dBm,    /* -14  dBm (hex: 0x07) */
  gAspPowerLevel_m13dBm,    /* -13  dBm (hex: 0x08) */
  gAspPowerLevel_m9dBm,      /* -9  dBm (hex: 0x09) */
  gAspPowerLevel_m7dBm,      /* -7  dBm (hex: 0x0A) */
  gAspPowerLevel_m4dBm,      /* -4  dBm (hex: 0x0B) */
  gAspPowerLevel_m2dBm,       /* -2 dBm (hex: 0x0C) */
  gAspPowerLevel_0dBm,       /* 0   dBm (hex: 0x0D) */
  gAspPowerLevel_1dBm          /* 1 dBm (hex: 0x0E) */
};


#define  gAspPowerLevel_m30dBm_c  (uint8_t)gAspPowerLevel_m30dBm
#define  gAspPowerLevel_m29dBm_c  (uint8_t)gAspPowerLevel_m29dBm
#define  gAspPowerLevel_m25dBm_c  (uint8_t)gAspPowerLevel_m25dBm
#define  gAspPowerLevel_m23dBm_c  (uint8_t)gAspPowerLevel_m23dBm
...
#define  gAspPowerLevel_m13dBm_c  (uint8_t)gAspPowerLevel_m13dBm
#define  gAspPowerLevel_m9dBm_c    (uint8_t)gAspPowerLevel_m9dBm
#define  gAspPowerLevel_m7dBm_c    (uint8_t)gAspPowerLevel_m7dBm
...
#define  gAspPowerLevel_1dBm_c       (uint8_t)gAspPowerLevel_1dBm
