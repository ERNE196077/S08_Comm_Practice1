/************************************************************************************
* This header file is for the MC1321x NCB port mappings.
*
...
*
************************************************************************************/
#ifndef _TARGET_MC1321x_NCB_
#define _TARGET_MC1321x_NCB_
#include "IoConfig.h"
...
//define UART handshake pins
  ...
  #define  mSETUP_PORT_A    PTAD  = 0x00;\
                            PTAPE |= mSWITCH_MASK;\
                            PTADD = (gSCI1RTSPin_c | gSCI2RTSPin_c ); // Set as input except 2 * RTS
