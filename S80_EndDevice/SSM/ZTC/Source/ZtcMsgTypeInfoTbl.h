...
#else
NwkAspTbl(aspMsgTypeTelecSendRawData_c,   aspMsgTypeTelecSendRawData_c,   gZtcMsgFlagSync_c,    sizeof(aspTelecSendRawData_t),                   gZtcMsgFmtAspTelecSendRawDataReq_c)  /* AspTelecSendRawData.Request  */
#endif //PROCESSOR_MC1323X
#ifdef PROCESSOR_MC1323X
NwkAspTbl(aspMsgTypeGetPpdMode_c,   aspMsgTypeGetPpdMode_c,   gZtcMsgFlagSync_c,    sizeof(aspPpdMode_t),                   gZtcMsgFmtSimple_c         ) /* AspGetPpdMode.Request  */
NwkAspTbl(aspMsgTypeSetPpdMode_c,   aspMsgTypeSetPpdMode_c,   gZtcMsgFlagSync_c,    sizeof(aspPpdMode_t),                   gZtcMsgFmtSimple_c         ) /* AspSetPpdMode.Request  */
#endif //PROCESSOR_MC1323X
#undef NwkAspTbl
...
AspNwkTbl(0x05, 0x05,        gZtcMsgFlagSync_c,    0,                       gZtcMsgFmtSimple_c             ) /* AspAcoma.Confirm              */
...
AspNwkTbl(0x0E, 0x0E,        gZtcMsgFlagSync_c,    0,                       gZtcMsgFmtSimple_c             ) /* AspSetNotifyReq.Confirm       */ 
...
#ifdef PROCESSOR_MC1323X
AspNwkTbl(0x17, 0x00,        gZtcMsgFlagSync_c,    0,                       gZtcMsgFmtSimple_c             ) /* AspGetPpdMode.Confirm      */
AspNwkTbl(0x18, 0x00,        gZtcMsgFlagSync_c,    0,                       gZtcMsgFmtSimple_c             ) /* AspSetPpdMode.Confirm      */
#endif //PROCESSOR_MC1323X
...
ZdoNlmeTbl(0x55, 0x56,        gZtcMsgFlagAsync_c,   sizeof(nlmeEnergyScanReq_t),                    gZtcMsgFmtSimple_c             ) /* NLME-Energy-Scan.Req            */
ZdoNlmeTbl(0x57, 0x58,        gZtcMsgFlagSync_c,    sizeof(nlmeSetChannelReq_t),                    gZtcMsgFmtSimple_c             ) /* NLME-RESET.Request              */
...
NlmeZdoTbl(0x56, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(nlmeEnergyScanCnf_t),                    gZtcMsgFmtMacScanCnf_c         ) /* NLME-Energy-Scan Confirm                */
#undef NlmeZdoTbl
...
ZtcMsgTbl(mZtcLowLevelMemoryWriteBlock_c,    ZtcWriteMemoryBlock)               /* ZTC-WriteRAMMemoryBlock.Request       */
ZtcMsgTbl(mZtcLowLevelMemoryReadBlock_c,     ZtcReadMemoryBlock)                /* ZTC-ReadMemoryBlock.Request           */
ZtcMsgTbl(mZtcLowLevelPing_c,                ZtcPing)                           /* ZTC-Ping.Request                      */
#ifdef PROCESSOR_MC1323X
ZtcMsgTbl(mZtcLowLevelMC1323xWriteTrimValue_c, ZtcMC1323xWriteTrimValue)                      /* ZTC-MC1323xWriteTrimValue.Request     */
ZtcMsgTbl(mZtcLowLevelMC1323xReadTrimValue_c,  ZtcMC1323xReadTrimValue)                       /* ZTC-MC1323xReadTrimValue.Request      */
#else
ZtcMsgTbl(mZtcLowLevelAbelWrite_c,           ZtcAbelWrite)                      /* ZTC-AbelWrite.Request                 */
ZtcMsgTbl(mZtcLowLevelAbelRead_c,            ZtcAbelRead)                       /* ZTC-AbelRead.Request                  */
#endif
#endif /* gUseHwValidation_c */

ZtcMsgTbl(mZtcMsgSelectWakeUpPINReq_c,      ZtcMsgSelectWakeUpPINReqFunc)       /* ZTC-SelectWakeUpPIN.Request          */
...
ZtcMsgTbl(mZtcMsgGetLastReceivedPacketLqiValue_c,    ZtcGetLastReceivedPacketLqiValue)               /* ZTC-GetLastReceivedPacketLqiValue.Request       */
ZtcMsgTbl(mZtcMsgGetMaxProgramStackUsage_c,    ZtcMsgGetMaxProgramStackUsage)
